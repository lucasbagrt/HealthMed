...
using User.Service.Validators.Auth;
...
public class AuthService : BaseService, IAuthService
{
    ...
    public AuthService(UserManager<Entities.User> userManager,
    ...
    private async Task<List<Claim>> GetAuthClaims(Entities.User user)
    {
